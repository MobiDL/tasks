...
task nanoplot_summary {
	...
	parameter_meta {
		...
		in: {
			description: 'Input summary file from guppy.',
			category: 'Required'
		}
		N50: {
			description: 'Show the N50 mark in the read length histogram (default: true)',
			category: 'Option'
		}
		dpi: {
